...
class ResnetBuilder(object):
    ...
    @staticmethod
    def build_resnet_19(input_shape, num_outputs):
        net,layer=ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 2, 2])
        shape =layer.get_shape()[1]
        weigt = layer.get_weights()[0]
        bias = layer.get_weights()[1]
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 2, 2]),shape,weigt,bias,layer
